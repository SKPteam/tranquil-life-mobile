...
import 'package:tranquil_app/app/getx_controllers/lock_screen_controller.dart';
...
import 'components/pin_number.dart';

class LockScreenView extends GetView<LockScreenController> {

  final LockScreenController _ = Get.put(LockScreenController());
